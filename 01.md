# Exercise 1: Create a secured vwan hub and azure firewall


1. In the Azure portal, type **firewall manager (1)** in the search box and select **firewall manager (2)** from results.
