...
1. If you encounter a “Pop-ups blocked” message when using **Azure Bastion**, follow these steps:
    ...
    1. When the pop-up is blocked, a small icon with a red 'x' will appear in the address bar (as shown in the image).
    
    2. Click on this **Pop-up blocked** icon.
    
    3. In the pop-up window that appears:

        * Select **"Always allow pop-ups and redirects from [https://portal.azure.com](https://portal.azure.com)"**.
...
1. Now, select **Application Rules (1)** from the Rules tab under the Firewall Policy page and select **+ Add a rule collection (2)**.
